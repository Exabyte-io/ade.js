...
export function NWChemTotalEnergyContextProviderMixin<T extends new (...args: any[]) => {}>(superclass: T) {
    const Base = JobContextMixin(WorkflowContextMixin(MethodDataContextMixin(MaterialContextMixin(superclass))));
    return class extends Base {
        ...
        */
        ...
        static symbolToAtomicSpecies(symbol, pseudo: { filename: string; path: string } | undefined = undefined) {
...
export const NWChemTotalEnergyContextProvider = NWChemTotalEnergyContextProviderMixin(ExecutableContextProvider);
export type NWChemTotalEnergyContextProvider = InstanceType<typeof NWChemTotalEnergyContextProvider>;
