...
export default class NWChemTotalEnergyContextProvider extends (ExecutableContextProvider as Base) {
    ...
    static symbolToAtomicSpecies(symbol: string, pseudo?: Pseudo) {
